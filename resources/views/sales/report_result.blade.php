...
@section('content')
    ...
    <div class="row">
        ...
        <div class="custom-col-md-12">
            ...
            <h4>Sales Report from {{ \Carbon\Carbon::parse($startDate)->format('Y-m-d') }} to
                {{ \Carbon\Carbon::parse($endDate)->format('Y-m-d') }}</h4>

                <a href="{{ route('sales.report.pdf', ['startDate' => $startDate, 'endDate' => $endDate]) }}"
