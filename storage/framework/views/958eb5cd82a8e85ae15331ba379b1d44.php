        ...
        <header id="header">
            ...
            <div class="header-content">
                <div class="header-date pull-left">
                    <strong><?php echo e(now()->timezone('Asia/Manila')->format('F j, Y, g:i a')); ?></strong>
                </div>
...
</html><?php /**PATH D:\xampp\htdocs\laravel-fims-main\resources\views/layouts/header.blade.php ENDPATH**/ ?>