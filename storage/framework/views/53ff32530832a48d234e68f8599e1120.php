                        ...
                        <div class="form-group">
                            ...
                            <select name="main_product_id" id="main_product_id" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($product->quantity > 0 && (!isset($product->expiration_date) || $product->expiration_date >= date('Y-m-d'))): ?>
                                        <option value="<?php echo e($product->id); ?>" <?php if(old('main_product_id') == $product->id || ($selectedProduct && $selectedProduct->id == $product->id)): ?> selected <?php endif; ?>
                                            data-price="<?php echo e($product->sale_price); ?>" data-name="<?php echo e($product->name); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-fims-main\resources\views/sales/index.blade.php ENDPATH**/ ?>