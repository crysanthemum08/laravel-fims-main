<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        ...
        <div class="custom-col-md-12">
            ...
            <h4>Sales Report from <?php echo e(\Carbon\Carbon::parse($startDate)->format('Y-m-d')); ?> to
                <?php echo e(\Carbon\Carbon::parse($endDate)->format('Y-m-d')); ?></h4>

                <a href="<?php echo e(route('sales.report.pdf', ['startDate' => $startDate, 'endDate' => $endDate])); ?>"
                class="btn btn-primary" style="margin-bottom: 20px;" target="_blank">
                 Download PDF</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-fims-main\resources\views/sales/report_result.blade.php ENDPATH**/ ?>